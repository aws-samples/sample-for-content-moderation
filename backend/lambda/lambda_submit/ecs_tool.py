...
from config import (REGION_NAME, CLUSTER_NAME, TASK_DEFINITION_ARN, SUBNET_IDS, PROGRAM_TYPE, CONTAINER_NAME,
                    ...
                    S3BUCKET_CUSTOMER_DIR, WHISPER_ENDPOINT_NAME, MODEL_ID, SECURITY_GROUP_ID, TAGS, IMG_MODEL_ID,
                    BATCH_PROCESS_IMG_NUMBER, SPEECH_RECOGNIZER_PLUGIN, TEXT_MODERATION_PLUGIN, IMAGE_MODERATION_PLUGIN,
