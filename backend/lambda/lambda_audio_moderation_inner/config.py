...
TASK_DETAIL_TABLE_NAME = os.environ.get('TASK_DETAIL_TABLE_NAME', 'Modetaion-xxxxx-002-ModerationTaskDetailTableBA6018C5-YQGVATJ5IU0M')

MODERATION_BUCKET_NAME = os.environ.get('MODERATION_BUCKET_NAME', 'content-modreation-us-west2')


WHISPER_ENDPOINT_NAME =  os.environ.get('WHISPER_ENDPOINT_NAME', 'content-moderation-endpoint-whisper-v3-58a0500f')
